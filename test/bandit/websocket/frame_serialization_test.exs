defmodule WebSocketFrameSerializationTest do
  ...
  describe "frame size" do
    test "serializes frames up to 125 bytes" do
      ...
      assert Frame.serialize(frame) == [[<<0x8::4, 0x2::4>>, <<0::1, 125::7>>, frame.data]]
    end
    ...
    test "serializes frames 126 bytes long" do
      ...
      assert Frame.serialize(frame) == [
               [<<0x8::4, 0x2::4>>, <<0::1, 126::7, 126::16>>, frame.data]
             ]
    end
    ...
    test "serializes frames 127 bytes long" do
      ...
      assert Frame.serialize(frame) == [
               [<<0x8::4, 0x2::4>>, <<0::1, 126::7, 127::16>>, frame.data]
             ]
    end
    ...
    test "serializes frames 16_000 bytes long" do
      ...
      assert Frame.serialize(frame) == [
               [<<0x8::4, 0x2::4>>, <<0::1, 126::7, 16_000::16>>, frame.data]
             ]
    end
    ...
    test "serializes frames 1_000_000 bytes long" do
      ...
      assert Frame.serialize(frame) == [
               [<<0x8::4, 0x2::4>>, <<0::1, 127::7, 1_000_000::64>>, frame.data]
             ]
    end
  end
  ...
  describe "CONTINUATION frames" do
    test "serializes frames with fin bit set" do
      ...
      assert Frame.serialize(frame) == [[<<0x8::4, 0x0::4>>, <<0::1, 125::7>>, frame.data]]
    end

    test "serializes frames with fin bit clear" do
      frame = %Frame.Continuation{fin: false, data: String.duplicate("a", 125)}

      assert Frame.serialize(frame) == [[<<0x0::4, 0x0::4>>, <<0::1, 125::7>>, frame.data]]
    end
  end
  ...
  describe "TEXT frames" do
    test "serializes frames with fin bit set" do
      ...
      assert Frame.serialize(frame) == [[<<0x8::4, 0x1::4>>, <<0::1, 125::7>>, frame.data]]
    end

    test "serializes frames with fin bit clear" do
      frame = %Frame.Text{fin: false, data: String.duplicate("a", 125)}

      assert Frame.serialize(frame) == [[<<0x0::4, 0x1::4>>, <<0::1, 125::7>>, frame.data]]
    end
  end
  ...
  describe "BINARY frames" do
    ...
    test "serializes frames with fin bit clear" do
      ...
      assert Frame.serialize(frame) == [[<<0x0::4, 0x2::4>>, <<0::1, 125::7>>, frame.data]]
    end
  end
  ...
  describe "CONNECTION_CLOSE frames" do
    test "serializes frames with code and message set" do
      ...
      assert Frame.serialize(frame) == [
               [<<0x8::4, 0x8::4>>, <<0::1, 125::7>>, [<<1000::16>>, frame.reason]]
             ]
    end
    ...
    test "serializes frames with no code set" do
      ...
      assert Frame.serialize(frame) == [[<<0x8::4, 0x8::4>>, <<0::1, 0::7>>, <<>>]]
    end
  end
  ...
  describe "PING frames" do
    test "serializes frames with data" do
      ...
      assert Frame.serialize(frame) == [[<<0x8::4, 0x9::4>>, <<0::1, 125::7>>, frame.data]]
    end

    test "serializes frames without data" do
      frame = %Frame.Ping{}

      assert Frame.serialize(frame) == [[<<0x8::4, 0x9::4>>, <<0::1, 0::7>>, <<>>]]
    end
  end
  ...
  describe "PONG frames" do
    test "serializes frames with data" do
      ...
      assert Frame.serialize(frame) == [[<<0x8::4, 0xA::4>>, <<0::1, 125::7>>, frame.data]]
    end

    test "serializes frames without data" do
      frame = %Frame.Pong{}

      assert Frame.serialize(frame) == [[<<0x8::4, 0xA::4>>, <<0::1, 0::7>>, <<>>]]
    end
  end
end
